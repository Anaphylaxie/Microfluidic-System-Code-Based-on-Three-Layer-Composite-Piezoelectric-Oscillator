...
class CompositeMaterialThermalConductivityPredictor:
    ...
    def preprocess_data(self, target_column="复合导热系数"):
        """
        数据预处理和特征工程
...
def main():
    ...
    data = predictor.load_data("7.17.xlsx")

    if data is not None:
        # 数据预处理
        predictor.preprocess_data(target_column="复合导热系数")
